...
use crate::db::schema::{dav_instance, dav_tombstone};
use crate::model::dav::instance::{DavInstance, NewDavInstance};
use crate::model::dav::tombstone::NewDavTombstone;
...
pub fn by_collection(
    ...
    all().filter(dav_instance::collection_id.eq(collection_id))
}
