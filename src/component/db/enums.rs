...
impl From<crate::component::rfc::ical::core::ComponentKind> for ComponentType {
    fn from(kind: crate::component::rfc::ical::core::ComponentKind) -> Self {
        use crate::component::rfc::ical::core::ComponentKind;
        match kind {
