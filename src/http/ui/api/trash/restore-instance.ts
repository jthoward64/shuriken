...
// ---------------------------------------------------------------------------
// POST /ui/api/trash/instances/:instanceId/restore
// ---------------------------------------------------------------------------

export const trashRestoreInstanceHandler = (
	_req: Request,
	...
	Effect.gen(function* () {
		...
		yield* trashSvc.restoreInstance(instanceId, principal.principalId).pipe(
			Effect.catchTags({
