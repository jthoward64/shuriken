...
//
// Shared, transport-neutral helper for deciding whether a request's client IP
// belongs to the configured set of trusted reverse proxies. Used to gate
// forwarded-URL reconstruction (X-Forwarded-Proto/Host) and SMTP credential
// overrides. The trust model is purely IP-based; no header is inspected here.
//
