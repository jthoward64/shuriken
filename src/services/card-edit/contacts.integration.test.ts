...
const sampleForm = (): ContactFormData => ({
	...
	familyName: "Builder",
	givenName: "Bob",
	emails: [{ value: "bob@example.com", types: ["home"], preferred: false }],
	tels: [{ value: "+1-555-0101", types: ["cell"], preferred: false }],
	bday: "1990-07-04",
	org: "Acme",
	title: "Architect",
	note: "Initial note",
			...
			const addressbookId = await runtime.runPromise(
				Effect.gen(function* () {
					...
					yield* svc.create(ab, {
						...
						tels: [{ value: "+1-555-0202", types: ["cell"], preferred: false }],
					});
					return ab;
				}),
			);
