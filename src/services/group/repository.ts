...
// ---------------------------------------------------------------------------
// GroupRepository — data access for group + principal + group_name + membership
// ---------------------------------------------------------------------------

export type PrincipalRow = InferSelectModel<typeof principal>;
export type GroupRow = InferSelectModel<typeof group>;
export type GroupNameRow = InferSelectModel<typeof groupName>;
...
export interface GroupWithPrincipal {
	...
	readonly primaryGroupName: GroupNameRow | null;
}
...
export interface GroupRepositoryShape {
	...
	readonly findByName: (
		name: string,
	) => Effect.Effect<Option.Option<GroupNameRow>, DatabaseError>;
